...
require (
	...
	github.com/raviqqe/hamt v0.0.0-20220630081707-76400bd6195c // indirect
...
require (
	github.com/SaoNetwork/sao v0.1.9-0.20231106025749-96485d314811
	github.com/SaoNetwork/sao-did v0.0.12
	github.com/SaoNetwork/sao-node v0.1.8-0.20231109032314-be3cd852b0a2
